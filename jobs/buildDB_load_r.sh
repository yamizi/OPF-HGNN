...
#python experiments/build_db.py --ray $RAY --cv_ratio $CV --num_samples $HP --mutations "load_relative+load_relative" --cases "case1354pegase+case1354pegase" --scale $SCALE --device $DEVICE --dataset_type $DATASET --comet_name $PROJECT --opf $OPF --nb_train $NB_TRAIN --nb_val $NB_VAL

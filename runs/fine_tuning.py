...
def run_case(training_cases=[["case9",64,0.7,["cost", "load"]]],experiment=None,
    ...
    finetune_train_losses, finetune_val_losses, finetune_val_losses_gen, finetune_val_losses_ext_grid, last_out, finetune_b_train_losses, finetune_b_val_losses, finetune_lr = train_opf(model,finetune_loader,

...
parser.add_argument('-o', '--origin_cases',
                    ...
                    type=str) 
def run(mutations = ["cost", "load_relative"],origin_mutations = ["cost", "load_relative"],origin_cases = ["case9","case14","case30","case118"],cases = ["case9","case14","case30","case118"],
    ...
    for i, case in enumerate(cases):
        ...
        experiment = init_comet({"origin_case":origin_case,"origin_mutation":origin_mutation,"case":case, "mutation":mutation},"test_finetuning_v4")
